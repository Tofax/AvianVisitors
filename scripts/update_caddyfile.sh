...
$legacy_handles
  ...
  @unknownAvianApi {
    path /avian/api/*
    not path /avian/api/archive.php /avian/api/birdnet-api.php /avian/api/birdnet-status.php /avian/api/birdweather.php /avian/api/config.php /avian/api/cutout.php /avian/api/cutout-review.php /avian/api/educator-audio-check.php /avian/api/educator-audio.php /avian/api/educators.php /avian/api/export.php /avian/api/fork-review.php /avian/api/generate.php /avian/api/maintenance.php /avian/api/menu.php /avian/api/recording.php /avian/api/spectrogram.php /avian/api/wiki.php
  }
