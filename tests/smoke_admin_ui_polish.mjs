...
assert.match(html, /styles\.css\?v=r190/, 'the polished styles have a fresh cache key');
assert.match(html, /apt\.js\?v=r218/, 'the polished behavior has a fresh cache key');
