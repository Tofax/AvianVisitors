...
assert.match(source, /Mostra sempre tot l.atles/, 'Settings copy is present in Catalan');
assert.match(source, /mostra tots els segells desbloquejats/, 'Settings explains the result in Catalan');
